...
public class Tab3 extends Fragment {
    ...
    private View v;
    private TextView txtFuturos;
    private NotificationManager mNM;

    public Tab3(Context mContext)
    {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       //SQliteDatabase
        ...
        txtFuturos = (TextView) v.findViewById(R.id.txtFuturos);
        txtFuturos.setVisibility(View.INVISIBLE);
        telaAnteriorLembrete="lembreteTab3";
        lvLembrete = (ListView) v.findViewById(R.id.listViewTab3);
        mNM = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);

        if (dbh.getLembretesFuturos().size() == 0) {
            lvLembrete.setVisibility(View.INVISIBLE);
            txtFuturos.setVisibility(View.VISIBLE);
            txtFuturos.setText("Sem lembretes futuros!");
        } else {
            txtFuturos.setVisibility(View.INVISIBLE);
            listaLembretes = dbh.getLembretesFuturos();
